...
//
//  Created by Алексей Азаренков on 14.02.2024.
//
        ...
        NavigationView {
            Form {
                ...
                Section(header: Text("Categories")) {
                    ...
                    let sortedByTimestamp = Array(selectedCategories).sorted(by: {$0.timestamp?.compare($1.timestamp ?? Date()) == .orderedDescending })
